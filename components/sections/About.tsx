...
import hichamPortrait from "@/app/assets/hicham-portrait.jpeg";
...
export function About() {
  ...
  return (
    <section ref={root} className="sec wrap" id="about">
      <div className="grid grid-cols-[1.05fr_0.95fr] gap-[70px] items-center max-[820px]:grid-cols-1 max-[820px]:gap-[54px]">
        ...
        <div>
          ...
          >
            <span>
              <span className="text-[var(--lime)]">ships</span> both sides.
            </span>
          </h2>
          <p
            data-fade
