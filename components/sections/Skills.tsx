...
export function Skills() {
  ...
  return (
    <section ref={root} className="sec wrap" id="skills">
      <div className="sec-head">
        <div>
          <div className="eyebrow" data-fade>Skills</div>
          <h2 className="sec-title r-line"><span>What I work with</span></h2>
        </div>
      </div>
...
function SkillRow({ n, title, desc }: { n: string; title: string; desc: string }) {
  return (
    <div
      data-fade
      data-cursor="→"
